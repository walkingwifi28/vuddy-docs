...
指定したテンプレートで使用されているデザインをそのまま利用できます。

初回あいさつ、再会あいさつと、それぞれのコンテンツ遷移があらかじめ設定されています。
...
34歳の法人営業担当者、個人事業主、士業、経営者など、初対面の相手に自分の活動やサービス内容を短時間で伝える必要があるビジネスパーソン。

紙の名刺だけでは、肩書き、事業内容、実績、人柄、SNS、問い合わせ先が断片的にしか伝わらない。名刺交換後に相手が自分のことを思い出しやすくし、興味を持ったタイミングで問い合わせや商談予約につなげたい。

##### 名刺を受け取る相手

展示会、交流会、商談、紹介の場で名刺を受け取った見込み顧客や協業候補。

その場では詳しい話を聞く時間が限られているが、後から相手のプロフィール、サービス内容、実績、相談できることを確認したい。長い会社紹介資料を読むより、自分の関心に近い情報だけを短時間で見たい。

#### Vuddyの利用シナリオ例

1. 名刺やデジタル名刺にVuddyのURLまたはQRコードを掲載する
2. 名刺を受け取った相手が、QRコードからVuddyにアクセスする
3. 相手が「プロフィール」「サービス内容」「実績」「相談できること」から知りたい情報を選択する
4. 選択内容に応じて、自己紹介動画、事業紹介、導入事例、SNSリンクを表示する
5. 動画内からSNSフォロー、問い合わせ、資料請求、商談予約へ誘導する
6. 再訪時には、前回見た内容に応じて追加情報や最新のお知らせを案内する
7. 導入ユーザーは、視聴数、選択率、離脱ポイント、問い合わせ率を確認し、名刺交換後のフォロー内容を改善する

#### 導入前/利用体験/導入後

##### 導入前

名刺交換だけでは相手の記憶に残りにくく、後日フォローしても自分の活動や相談できる内容を思い出してもらいにくい

##### 利用体験

名刺を受け取った相手が、QRコードから自分の関心に合うプロフィールやサービス情報を選びながら確認できる

##### 導入後

名刺交換後の接点が継続し、SNSフォロー、問い合わせ、商談予約、紹介につながりやすくなる

#### KPI例

QRコードアクセス率、視聴完了率、選択肢クリック率、SNSフォロー率、問い合わせ率、商談予約率、再訪率、名刺交換後のフォロー返信率
...
<!--| プラン                                                   | Standard   | Plus       | 永続ライセンス                                           |
| -------------------------------------------------------- | ---------- | ---------- | -------------------------------------------------------- |
| 価格                                                     | ￥2,980/月 | ￥9,980/月 | 料金については、`info@vuddy.com`にお問い合わせください。 |
| Vuddy制作支援                                            | ×          | ×          | ○                                                        |
| 視聴URLカスタム                                          | ○          | ○          | ○                                                        |
| Vuddy作成上限数                                          | 3つまで    | 3つまで    | 無制限                                                   |
| テンプレ利用                                             | ○          | ○          | ○                                                        |
| テンプレ編集（色、テキスト、画像）                       | ○          | ○          | ○                                                        |
| SNSリンク編集                                            | ○          | ○          | ○                                                        |
| ボタン分岐                                               | ○          | ○          | ○                                                        |
...
| 入力フォーム設置                                         | ×          | ×          | ○                                                        |
| 独自デザインのVuddy作成                                  | ×          | ○          | ○                                                        |
| 月間視聴数制限                                           | 10,000     | 10,000     | 上限については、`info@vuddy.com`にお問い合わせください。 |
| 視聴数・視聴ユーザー数・総視聴時間表示                   | ○          | ○          | ○                                                        |
| 選択肢遷移率・視聴完了率・離脱ポイント・エンゲージメント | ×          | ×          | ○                                                        |
| ユーザー分析                                             | ×          | ×          | ○                                                        |
| 入力フォーム収集                                         | ×          | ×          | ○                                                        |
| AI分析レポート (開発中)                                  | ×          | ×          | ○                                                        |-->
...
| プラン                                                   | Plus         | 永続ライセンス                                           |
| -------------------------------------------------------- | ------------ | -------------------------------------------------------- |
| 価格                                                     | ￥300,000/年 | 料金については、`info@vuddy.com`にお問い合わせください。 |
| Vuddy制作支援                                            | ×            | ○                                                        |
| 視聴URLカスタム                                          | ○            | ○                                                        |
| Vuddy作成上限数                                          | 1つまで      | 無制限                                                   |
| テンプレ利用                                             | ○            | ○                                                        |
...
| 入力フォーム設置                                         | ×            | ○                                                        |
| 独自デザインのVuddy作成                                  | ○            | ○                                                        |
| 月間視聴数制限                                           | 10,000       | 上限については、`info@vuddy.com`にお問い合わせください。 |
| 視聴数・視聴ユーザー数・総視聴時間表示                   | ○            | ○                                                        |
| 選択肢遷移率・視聴完了率・離脱ポイント・エンゲージメント | ○            | ○                                                        |
| ユーザー分析                                             | ○            | ○                                                        |
| 入力フォーム収集                                         | ○            | ○                                                        |
